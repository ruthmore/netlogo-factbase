 ...
 *
 */
public class FactBaseRetrieve extends DefaultReporter {
	...
	/** Returns all facts satisfying the given condition from the specified fact base. The first argument {@link args[0]} has
