 ...
 *
 */
public class FactBaseSize implements Reporter {
	...
	/** Returns the size of the specified fact base, that is the number of facts in this fact base. The first argument {@code args[0]} has
	 * to be a fact base-
